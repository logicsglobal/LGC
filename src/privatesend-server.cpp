...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Lgc related functionality
...
/*
    ...
    allow endless transaction that would bloat Lgc and make it unusable. To
