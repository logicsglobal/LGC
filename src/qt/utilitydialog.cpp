    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  lgc-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Lgc in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 LGC, 0.1 LGC, 1 LGC and 10 LGC -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://lgcpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://lgcpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
