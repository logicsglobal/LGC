    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("LGC-light"), QVariant("light"));
    ui->theme->addItem(QString("LGC-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("LGC-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("LGC-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("LGC-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("LGC-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("LGC-traditional"), QVariant("trad"));
