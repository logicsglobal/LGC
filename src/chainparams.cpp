...
{
    const char* pszTimestamp = "Wired 2018-09-09 The LGC Growing Up Your Life Is Now Accepting Bitcoins";
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1536491345, 212869, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
//printf("genesis.GetHash = %s\n", genesis.GetHash().ToString().c_str());
assert(consensus.hashGenesisBlock == uint256S("0x0000044fe85dc834ab8bd94ae2adffa9aa63b8618ffc04e0bb64c326d67d2bb7"));
assert(genesis.hashMerkleRoot == uint256S("0xc298e54dcc0909c0d2c72d49b2141a4d08b997e9ccfa8be025ea84deecdeb558"));

 
        vSeeds.push_back(CDNSSeedData("lgcry.com", "seed.lgcry.com"));
        ...
        //strSporkAddress = "Xrc3UKQDnhZCWVJtPUqWFwdMxRt8hHay6B";
        strSporkAddress = "Xgnntu8nwFfk8BsM6dEHiYxa6rK9yAuB8s";
        ...
        checkpointData = (CCheckpointData){
            ...
            ( 10000, uint256S("0x0000015e28b3c1fc93a6d208d4a96569c9f89f99d3383974ecf92ccc000a9609"))
            ( 22222, uint256S("0x00000082cafb322f9468fefff3120dff0a9c505811d9cef0146218b86e59b069"))
        };
...
//assert(genesis.hashMerkleRoot == uint256S("0x91ebac2eae7d65a6ef31e739196b142aa8fc47c41cd10f03b460829f56310131"));
        ...
        vSeeds.push_back(CDNSSeedData("lgcry.com", "testnet-seed.lgcry.com"));
