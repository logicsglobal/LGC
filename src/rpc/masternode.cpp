...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print Lgc address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "lgc",               "masternode",             &masternode,             true,  {} },
    { "lgc",               "masternodelist",         &masternodelist,         true,  {} },
    { "lgc",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "lgc",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "lgc",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "lgc",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
