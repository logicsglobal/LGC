...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in lgc.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("lgc.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* Lgc features */
    { "lgc",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "lgc",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "lgc",               "gobject",                &gobject,                true,  {} },
    { "lgc",               "voteraw",                &voteraw,                true,  {} },
