/* src/config/lgc-config.h.  Generated from lgc-config.h.in by configure.  */
/* src/config/lgc-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Lgc Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Lgc Core"
...
#define PACKAGE_BUGREPORT "https://github.com/LGCry/lgc/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Lgc Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Lgc Core 0.12.3"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "lgccore"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://lgcry.org/"
